                        ...
                        <div class="box">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <a class="btn btn-success btn-flat" data-toggle="modal" href="<?php echo site_url() . '/admin/register' ?>"><span class="fa fa-user-plus"></span> Add Pengguna</a>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:right;">
                                                        ...
                                                        <a class="btn" href="<?php echo site_url() . '/admin/pengguna/reset_password/' . $pengguna_id; ?>"><span class="fa fa-refresh"></span></a>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $pengguna_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo site_url() . '/admin/pengguna/update_pengguna_admin' ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
