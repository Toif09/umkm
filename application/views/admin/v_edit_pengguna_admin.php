...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="box box-default">
          ...
          ?>
            <form action="<?php echo site_url() . '/admin/pengguna/update_pengguna_admin' ?>" method="post" enctype="multipart/form-data">

              <!-- /.box-header -->
              <div class="box-body">
                <div class="row">
                  <div class="col-md-10">
                    <input type="hidden" name="kode" value="<?php echo $b['pengguna_id']; ?>">
                    <input type="text" name="xnama" class="form-control" value="<?php echo $pengguna_nama; ?>" placeholder="Judul berita atau artikel" required />
                  </div>
                  <!-- /.col -->
                  <div class="col-md-2">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-danger">
              ...
              <div class="box-body">
                ...
                <textarea id="ckeditor" name="xtentang" required><?php echo $pengguna_alamat; ?></textarea>
            ...
            <div class="box box-primary">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="xpemilik" class="form-control" value="<?php echo $b['pengguna_pemilik']; ?>" placeholder="Masukan Nama Pemilik" required />
              ...
              <div class="box-body">
                ...
                <select class="form-control select2" name="xkategori" style="width: 100%;" required>
                  ...
                  foreach ($kat->result_array() as $i) {
                    ...
                    if ($b['produk_kategori_id'] == $kategori_id)
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2022 <a href="https://youtube.com/channel/UCGggbot2ZxCzQLvfkccFoqg">Toif m</a>.</strong> All rights reserved. | Repost by <a href='https://youtube.com/channel/UCGggbot2ZxCzQLvfkccFoqg' title='koi' target='_blank'>YouTube</a>
    </footer>
