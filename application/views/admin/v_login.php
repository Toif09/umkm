...
<body class="d-flex align-items-center">
        ...
        <div class="animate form-login">
          <section class="">
            <form action="<?php echo site_url('/administrator/auth') ?>" method="POST">
              <h3 class="text-danger"><i class="fa fa-map-marker"></i> UMKM </h3>
              <h1> Form Login | UMKM Kertawaluya
              </h1>
  ...
  <div class="col-md-6 d-xs-none">
    <img src="<?php echo base_url('assets/images/logoumkm.png') ?>" width="80%">
  </div>
</body>
