        ...
        <section class="page-section" id="detail">
          ...
          <div class="container">
            <div class="text-center">
              ...
              <h3 class="section-subheading text-muted">Detail lengkap dari produk umkm </h3>
            </div>
            ...
            <div class="card" style="max-width: 1500px;">
              <div class="row no-gutters">
                ...
                <div class="col-md-7">
                  <div class="card-body">
                    <h4 class="card-title text-uppercase mb-4"><i class="fas fa-store-alt mr-4"></i> <?php echo $b['pengguna_nama']; ?></h4>
                    <hr>
                    ...
                    <p class="card-text">
                      ...
                      <a class="btn btn-info" href="https://api.whatsapp.com/send?phone=628535356565&text=Hallo..%20Saya%20tertarik%20dengan%20produk%20ini%20*NAMA%20PRODUK*" role="button"><i class="fas fa-cart-plus"></i> Pesan Via WhatsApp</a>
                    </p>
